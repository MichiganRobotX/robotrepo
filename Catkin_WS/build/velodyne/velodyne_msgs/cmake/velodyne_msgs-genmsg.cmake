...
set(MSG_I_FLAGS "-Ivelodyne_msgs:/home/robotx/github/robotrepo/Catkin_WS/src/velodyne/velodyne_msgs/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/velodyne/velodyne_msgs/msg/VelodynePacket.msg" NAME_WE)
add_custom_target(_velodyne_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "velodyne_msgs" "/home/robotx/github/robotrepo/Catkin_WS/src/velodyne/velodyne_msgs/msg/VelodynePacket.msg" ""
)

get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/velodyne/velodyne_msgs/msg/VelodyneScan.msg" NAME_WE)
add_custom_target(_velodyne_msgs_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "velodyne_msgs" "/home/robotx/github/robotrepo/Catkin_WS/src/velodyne/velodyne_msgs/msg/VelodyneScan.msg" "std_msgs/Header:velodyne_msgs/VelodynePacket"
)
...
_generate_msg_cpp(velodyne_msgs
  ...
  "${MSG_I_FLAGS}"
  "/opt/ros/kinetic/share/std_msgs/cmake/../msg/Header.msg;/home/robotx/github/robotrepo/Catkin_WS/src/velodyne/velodyne_msgs/msg/VelodynePacket.msg"
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/velodyne_msgs
)
...
### Generating Messages
_generate_msg_java(velodyne_msgs
  "/home/robotx/github/robotrepo/Catkin_WS/src/velodyne/velodyne_msgs/msg/VelodynePacket.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/velodyne_msgs
)
_generate_msg_java(velodyne_msgs
  "/home/robotx/github/robotrepo/Catkin_WS/src/velodyne/velodyne_msgs/msg/VelodyneScan.msg"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_java(velodyne_msgs
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/velodyne_msgs
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(velodyne_msgs_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(velodyne_msgs_generate_messages velodyne_msgs_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/velodyne/velodyne_msgs/msg/VelodynePacket.msg" NAME_WE)
add_dependencies(velodyne_msgs_generate_messages_java _velodyne_msgs_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/velodyne/velodyne_msgs/msg/VelodyneScan.msg" NAME_WE)
add_dependencies(velodyne_msgs_generate_messages_java _velodyne_msgs_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(velodyne_msgs_genjava)
add_dependencies(velodyne_msgs_genjava velodyne_msgs_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS velodyne_msgs_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/velodyne_msgs)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/velodyne_msgs
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(velodyne_msgs_generate_messages_java std_msgs_generate_messages_java)
endif()
