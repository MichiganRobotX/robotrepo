...
if(lidar_transform_CONFIG_INCLUDED)
  return()
endif()
set(lidar_transform_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(lidar_transform_SOURCE_PREFIX /home/robotx/github/robotrepo/Catkin_WS/src/lidar_transform)
  set(lidar_transform_DEVEL_PREFIX /home/robotx/github/robotrepo/Catkin_WS/devel)
  set(lidar_transform_INSTALL_PREFIX "")
  set(lidar_transform_PREFIX ${lidar_transform_DEVEL_PREFIX})
else()
  set(lidar_transform_SOURCE_PREFIX "")
  set(lidar_transform_DEVEL_PREFIX "")
  set(lidar_transform_INSTALL_PREFIX /home/robotx/github/robotrepo/Catkin_WS/install)
  set(lidar_transform_PREFIX ${lidar_transform_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lidar_transform' is deprecated")
...
set(lidar_transform_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.2;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/libxml2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/python2.7;/usr/include/tcl " STREQUAL " ")
  set(lidar_transform_INCLUDE_DIRS "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lidar_transform_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lidar_transform' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lidar_transform' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotx/github/robotrepo/Catkin_WS/install/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lidar_transform_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lidar_transform_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(lidar_transform_LIBRARY_DIRS ${lib_path})
      list(APPEND lidar_transform_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lidar_transform'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lidar_transform_LIBRARIES ${lib})
    endif()
  endif()
...
set(lidar_transform_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lidar_transform_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 lidar_transform_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lidar_transform_dep}_FOUND)
      find_package(${lidar_transform_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lidar_transform_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lidar_transform_INCLUDE_DIRS ${${lidar_transform_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lidar_transform_LIBRARIES ${lidar_transform_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lidar_transform_dep}_LIBRARIES})
  _list_append_deduplicate(lidar_transform_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lidar_transform_LIBRARIES ${lidar_transform_LIBRARIES})

  _list_append_unique(lidar_transform_LIBRARY_DIRS ${${lidar_transform_dep}_LIBRARY_DIRS})
  list(APPEND lidar_transform_EXPORTED_TARGETS ${${lidar_transform_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lidar_transform_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
