...
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/image_common/polled_camera/srv/GetPolledImage.srv" NAME_WE)
add_custom_target(_polled_camera_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "polled_camera" "/home/robotx/github/robotrepo/Catkin_WS/src/image_common/polled_camera/srv/GetPolledImage.srv" "sensor_msgs/RegionOfInterest"
)
...
_generate_srv_cpp(polled_camera
  "/home/robotx/github/robotrepo/Catkin_WS/src/image_common/polled_camera/srv/GetPolledImage.srv"
  "${MSG_I_FLAGS}"
...
### Generating Services
_generate_srv_java(polled_camera
  "/home/robotx/github/robotrepo/Catkin_WS/src/image_common/polled_camera/srv/GetPolledImage.srv"
  "${MSG_I_FLAGS}"
  "/opt/ros/kinetic/share/sensor_msgs/cmake/../msg/RegionOfInterest.msg"
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/polled_camera
)

### Generating Module File
_generate_module_java(polled_camera
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/polled_camera
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(polled_camera_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(polled_camera_generate_messages polled_camera_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/image_common/polled_camera/srv/GetPolledImage.srv" NAME_WE)
add_dependencies(polled_camera_generate_messages_java _polled_camera_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(polled_camera_genjava)
add_dependencies(polled_camera_genjava polled_camera_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS polled_camera_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/polled_camera)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/polled_camera
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET sensor_msgs_generate_messages_java)
  add_dependencies(polled_camera_generate_messages_java sensor_msgs_generate_messages_java)
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(polled_camera_generate_messages_java std_msgs_generate_messages_java)
endif()
