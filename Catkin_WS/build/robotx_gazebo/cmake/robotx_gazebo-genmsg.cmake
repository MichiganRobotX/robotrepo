...
set(MSG_I_FLAGS "-Irobotx_gazebo:/home/robotx/github/robotrepo/Catkin_WS/src/robotx_gazebo/msg;-Igeometry_msgs:/opt/ros/kinetic/share/geometry_msgs/cmake/../msg;-Inav_msgs:/opt/ros/kinetic/share/nav_msgs/cmake/../msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg;-Iactionlib_msgs:/opt/ros/kinetic/share/actionlib_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/robotx_gazebo/msg/UsvDrive.msg" NAME_WE)
add_custom_target(_robotx_gazebo_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robotx_gazebo" "/home/robotx/github/robotrepo/Catkin_WS/src/robotx_gazebo/msg/UsvDrive.msg" ""
)
...
_generate_msg_cpp(robotx_gazebo
  "/home/robotx/github/robotrepo/Catkin_WS/src/robotx_gazebo/msg/UsvDrive.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_java(robotx_gazebo
  "/home/robotx/github/robotrepo/Catkin_WS/src/robotx_gazebo/msg/UsvDrive.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robotx_gazebo
)

### Generating Services

### Generating Module File
_generate_module_java(robotx_gazebo
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robotx_gazebo
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(robotx_gazebo_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(robotx_gazebo_generate_messages robotx_gazebo_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/robotx_gazebo/msg/UsvDrive.msg" NAME_WE)
add_dependencies(robotx_gazebo_generate_messages_java _robotx_gazebo_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(robotx_gazebo_genjava)
add_dependencies(robotx_gazebo_genjava robotx_gazebo_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS robotx_gazebo_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robotx_gazebo)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robotx_gazebo
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET geometry_msgs_generate_messages_java)
  add_dependencies(robotx_gazebo_generate_messages_java geometry_msgs_generate_messages_java)
endif()
if(TARGET nav_msgs_generate_messages_java)
  add_dependencies(robotx_gazebo_generate_messages_java nav_msgs_generate_messages_java)
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(robotx_gazebo_generate_messages_java std_msgs_generate_messages_java)
endif()
