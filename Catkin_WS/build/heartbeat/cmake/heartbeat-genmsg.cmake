...
set(MSG_I_FLAGS "-Iheartbeat:/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/finalMsg.msg" NAME_WE)
add_custom_target(_heartbeat_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "heartbeat" "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/finalMsg.msg" ""
)

get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/detectDeliver.msg" NAME_WE)
add_custom_target(_heartbeat_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "heartbeat" "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/detectDeliver.msg" ""
)

get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/scanCode.msg" NAME_WE)
add_custom_target(_heartbeat_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "heartbeat" "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/scanCode.msg" ""
)

get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/entranceExit.msg" NAME_WE)
add_custom_target(_heartbeat_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "heartbeat" "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/entranceExit.msg" ""
)

get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/dockTask.msg" NAME_WE)
add_custom_target(_heartbeat_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "heartbeat" "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/dockTask.msg" ""
)

get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/heartBeat.msg" NAME_WE)
add_custom_target(_heartbeat_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "heartbeat" "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/heartBeat.msg" ""
)
...
_generate_msg_cpp(heartbeat
  "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/finalMsg.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/heartbeat
)
_generate_msg_cpp(heartbeat
  "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/detectDeliver.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/heartbeat
)
_generate_msg_cpp(heartbeat
  "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/scanCode.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/heartbeat
)
_generate_msg_cpp(heartbeat
  "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/entranceExit.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/heartbeat
)
_generate_msg_cpp(heartbeat
  "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/dockTask.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/heartbeat
)
_generate_msg_cpp(heartbeat
  "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/heartBeat.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/heartbeat
)
...
### Generating Messages
_generate_msg_java(heartbeat
  "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/finalMsg.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/heartbeat
)
_generate_msg_java(heartbeat
  "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/detectDeliver.msg"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_java(heartbeat
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/heartbeat
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(heartbeat_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(heartbeat_generate_messages heartbeat_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/finalMsg.msg" NAME_WE)
add_dependencies(heartbeat_generate_messages_java _heartbeat_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/detectDeliver.msg" NAME_WE)
add_dependencies(heartbeat_generate_messages_java _heartbeat_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/heartbeat/msg/scanCode.msg" NAME_WE)
add_dependencies(heartbeat_generate_messages_java _heartbeat_generate_messages_check_deps_${_filename})
...
# target for backward compatibility
add_custom_target(heartbeat_genjava)
add_dependencies(heartbeat_genjava heartbeat_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS heartbeat_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/heartbeat)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/heartbeat
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(heartbeat_generate_messages_java std_msgs_generate_messages_java)
endif()
