...
if(multi_lidar_calib_CONFIG_INCLUDED)
  return()
endif()
set(multi_lidar_calib_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(multi_lidar_calib_SOURCE_PREFIX /home/robotx/github/robotrepo/Catkin_WS/src/multi_lidar_loam_calibration)
  set(multi_lidar_calib_DEVEL_PREFIX /home/robotx/github/robotrepo/Catkin_WS/devel)
  set(multi_lidar_calib_INSTALL_PREFIX "")
  set(multi_lidar_calib_PREFIX ${multi_lidar_calib_DEVEL_PREFIX})
else()
  set(multi_lidar_calib_SOURCE_PREFIX "")
  set(multi_lidar_calib_DEVEL_PREFIX "")
  set(multi_lidar_calib_INSTALL_PREFIX /home/robotx/github/robotrepo/Catkin_WS/install)
  set(multi_lidar_calib_PREFIX ${multi_lidar_calib_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'multi_lidar_calib' is deprecated")
...
set(multi_lidar_calib_FOUND_CATKIN_PROJECT TRUE)

if(NOT "include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.2;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/libxml2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/python2.7;/usr/include/tcl " STREQUAL " ")
  set(multi_lidar_calib_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/eigen3;/usr/include/pcl-1.7;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.2;/usr/include/jsoncpp;/usr/include/hdf5/openmpi;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent;/usr/lib/openmpi/include/openmpi/opal/mca/event/libevent2021/libevent/include;/usr/lib/openmpi/include;/usr/lib/openmpi/include/openmpi;/usr/include/libxml2;/usr/include/freetype2;/usr/include/x86_64-linux-gnu/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/python2.7;/usr/include/tcl")
  if(NOT " " STREQUAL " ")
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robotx/github/robotrepo/Catkin_WS/install/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(multi_lidar_calib_LIBRARY_DIRS ${lib_path})
      list(APPEND multi_lidar_calib_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'multi_lidar_calib'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND multi_lidar_calib_LIBRARIES ${lib})
    endif()
  endif()
...
set(multi_lidar_calib_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${multi_lidar_calib_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 multi_lidar_calib_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${multi_lidar_calib_dep}_FOUND)
      find_package(${multi_lidar_calib_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${multi_lidar_calib_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(multi_lidar_calib_INCLUDE_DIRS ${${multi_lidar_calib_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(multi_lidar_calib_LIBRARIES ${multi_lidar_calib_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${multi_lidar_calib_dep}_LIBRARIES})
  _list_append_deduplicate(multi_lidar_calib_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(multi_lidar_calib_LIBRARIES ${multi_lidar_calib_LIBRARIES})

  _list_append_unique(multi_lidar_calib_LIBRARY_DIRS ${${multi_lidar_calib_dep}_LIBRARY_DIRS})
  list(APPEND multi_lidar_calib_EXPORTED_TARGETS ${${multi_lidar_calib_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${multi_lidar_calib_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
