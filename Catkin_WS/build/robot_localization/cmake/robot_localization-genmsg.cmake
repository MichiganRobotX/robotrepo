...
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/GetState.srv" NAME_WE)
add_custom_target(_robot_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_localization" "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/GetState.srv" ""
)

get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/SetDatum.srv" NAME_WE)
add_custom_target(_robot_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_localization" "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/SetDatum.srv" "geographic_msgs/GeoPose:geographic_msgs/GeoPoint:geometry_msgs/Quaternion"
)

get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/SetPose.srv" NAME_WE)
add_custom_target(_robot_localization_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_localization" "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/SetPose.srv" "std_msgs/Header:geometry_msgs/Quaternion:geometry_msgs/Point:geometry_msgs/PoseWithCovariance:geometry_msgs/PoseWithCovarianceStamped:geometry_msgs/Pose"
)
...
### Generating Services
_generate_srv_java(robot_localization
  "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/GetState.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robot_localization
)
_generate_srv_java(robot_localization
  "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/SetDatum.srv"
  "${MSG_I_FLAGS}"
...
### Generating Module File
_generate_module_java(robot_localization
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robot_localization
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(robot_localization_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(robot_localization_generate_messages robot_localization_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/GetState.srv" NAME_WE)
add_dependencies(robot_localization_generate_messages_java _robot_localization_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/SetDatum.srv" NAME_WE)
add_dependencies(robot_localization_generate_messages_java _robot_localization_generate_messages_check_deps_${_filename})
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/robot_localization/srv/SetPose.srv" NAME_WE)
add_dependencies(robot_localization_generate_messages_java _robot_localization_generate_messages_check_deps_${_filename})
...
# target for backward compatibility
add_custom_target(robot_localization_genjava)
add_dependencies(robot_localization_genjava robot_localization_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS robot_localization_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robot_localization)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robot_localization
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET geographic_msgs_generate_messages_java)
  add_dependencies(robot_localization_generate_messages_java geographic_msgs_generate_messages_java)
endif()
if(TARGET geometry_msgs_generate_messages_java)
  add_dependencies(robot_localization_generate_messages_java geometry_msgs_generate_messages_java)
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(robot_localization_generate_messages_java std_msgs_generate_messages_java)
endif()
