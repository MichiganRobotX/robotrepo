...
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/robot_pose_ekf/srv/GetStatus.srv" NAME_WE)
add_custom_target(_robot_pose_ekf_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "robot_pose_ekf" "/home/robotx/github/robotrepo/Catkin_WS/src/robot_pose_ekf/srv/GetStatus.srv" ""
)
...
_generate_srv_cpp(robot_pose_ekf
  "/home/robotx/github/robotrepo/Catkin_WS/src/robot_pose_ekf/srv/GetStatus.srv"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_java(robot_pose_ekf
  "/home/robotx/github/robotrepo/Catkin_WS/src/robot_pose_ekf/srv/GetStatus.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robot_pose_ekf
)

### Generating Module File
_generate_module_java(robot_pose_ekf
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robot_pose_ekf
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(robot_pose_ekf_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(robot_pose_ekf_generate_messages robot_pose_ekf_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/robotx/github/robotrepo/Catkin_WS/src/robot_pose_ekf/srv/GetStatus.srv" NAME_WE)
add_dependencies(robot_pose_ekf_generate_messages_java _robot_pose_ekf_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(robot_pose_ekf_genjava)
add_dependencies(robot_pose_ekf_genjava robot_pose_ekf_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS robot_pose_ekf_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robot_pose_ekf)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/robot_pose_ekf
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(robot_pose_ekf_generate_messages_java std_msgs_generate_messages_java)
endif()
