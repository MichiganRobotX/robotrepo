...
"""autogenerated by genpy from detection/BoundingBoxes.msg. Do not edit."""
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','detection/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = detection.msg.BoundingBox()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
