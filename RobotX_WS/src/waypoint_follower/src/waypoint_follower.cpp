...
int main (int argc, char** argv)
{
  ...
  linear_pos_pid_pub = nh.advertise<waypoint_follower::PID>("/pid/lin_pos", 10000);
  linear_vel_pid_pub = nh.advertise<waypoint_follower::PID>("/pid/lin_vel", 10000);
  angular_pid_pub = nh.advertise<waypoint_follower::PID>("/pid/angular", 10000);
  tuning_param_pub = nh.advertise<waypoint_follower::TuningParameters>("/pid/tuning_params", 10000);
