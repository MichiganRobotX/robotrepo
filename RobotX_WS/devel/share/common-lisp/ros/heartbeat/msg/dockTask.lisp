...
(cl:defclass <dockTask> (roslisp-msg-protocol:ros-message)
  ((msgID
    :reader msgID
    :initarg :msgID
    :type cl:string
...
(cl:defclass dockTask (<dockTask>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <dockTask>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'dockTask)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name heartbeat-msg:<dockTask> is deprecated: use heartbeat-msg:dockTask instead.")))

(cl:ensure-generic-function 'msgID-val :lambda-list '(m))
(cl:defmethod msgID-val ((m <dockTask>))
...
(cl:defmethod date-val ((m <dockTask>))
...
(cl:defmethod time-val ((m <dockTask>))
...
(cl:defmethod teamID-val ((m <dockTask>))
...
(cl:defmethod shapeColor-val ((m <dockTask>))
...
(cl:defmethod shape-val ((m <dockTask>))
...
(cl:defmethod checksum-val ((m <dockTask>))
  ...
  (checksum m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <dockTask>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <dockTask>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<dockTask>)))
  "Returns string type for a message object of type '<dockTask>"
  "heartbeat/dockTask")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'dockTask)))
  "Returns string type for a message object of type 'dockTask"
  "heartbeat/dockTask")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<dockTask>)))
  "Returns md5sum for a message object of type '<dockTask>"
  "ce0c58613dee387ebf511525a16db3e0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'dockTask)))
  "Returns md5sum for a message object of type 'dockTask"
  "ce0c58613dee387ebf511525a16db3e0")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<dockTask>)))
  "Returns full string definition for message of type '<dockTask>"
  (cl:format cl:nil "string msgID~%string date~%string time~%string teamID~%string shapeColor~%string shape~%int32 checksum~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'dockTask)))
  "Returns full string definition for message of type 'dockTask"
  (cl:format cl:nil "string msgID~%string date~%string time~%string teamID~%string shapeColor~%string shape~%int32 checksum~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <dockTask>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <dockTask>))
