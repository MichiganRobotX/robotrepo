...
(cl:defmethod cl:initialize-instance :after ((m <TuningParameters>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TuningParameters)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name waypoint_follower_pid-msg:<TuningParameters> is deprecated: use waypoint_follower_pid-msg:TuningParameters instead.")))

(cl:ensure-generic-function 'out_x-val :lambda-list '(m))
(cl:defmethod out_x-val ((m <TuningParameters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_follower_pid-msg:out_x-val is deprecated.  Use waypoint_follower_pid-msg:out_x instead.")
  (out_x m))

(cl:ensure-generic-function 'out_v-val :lambda-list '(m))
(cl:defmethod out_v-val ((m <TuningParameters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_follower_pid-msg:out_v-val is deprecated.  Use waypoint_follower_pid-msg:out_v instead.")
  (out_v m))

(cl:ensure-generic-function 'err_v-val :lambda-list '(m))
(cl:defmethod err_v-val ((m <TuningParameters>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader waypoint_follower_pid-msg:err_v-val is deprecated.  Use waypoint_follower_pid-msg:err_v instead.")
  (err_v m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <TuningParameters>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'out_v))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'err_v))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <TuningParameters>) istream)
  "Deserializes a message object of type '<TuningParameters>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'out_v) (roslisp-utils:decode-single-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'err_v) (roslisp-utils:decode-single-float-bits bits)))
  msg
)
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TuningParameters>)))
  ...
  "waypoint_follower_pid/TuningParameters")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TuningParameters)))
  "Returns string type for a message object of type 'TuningParameters"
  "waypoint_follower_pid/TuningParameters")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<TuningParameters>)))
  ...
  "0980976f0bdca75f72b664cc976a51bc")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'TuningParameters)))
  "Returns md5sum for a message object of type 'TuningParameters"
  "0980976f0bdca75f72b664cc976a51bc")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TuningParameters>)))
  ...
  (cl:format cl:nil "# Tuning message~%float32 out_x~%float32 out_v~%float32 err_v~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TuningParameters)))
  "Returns full string definition for message of type 'TuningParameters"
  (cl:format cl:nil "# Tuning message~%float32 out_x~%float32 out_v~%float32 err_v~%~%~%"))
