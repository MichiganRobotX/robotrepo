...
class TuningParameters {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float64(obj.out_x, buffer, bufferOffset);
    // Serialize message field [out_v]
    bufferOffset = _serializer.float64(obj.out_v, buffer, bufferOffset);
    // Serialize message field [err_v]
    bufferOffset = _serializer.float64(obj.err_v, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.out_x = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [out_v]
    data.out_v = _deserializer.float64(buffer, bufferOffset);
    // Deserialize message field [err_v]
    data.err_v = _deserializer.float64(buffer, bufferOffset);
    return data;
  }
